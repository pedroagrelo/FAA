...
df_knn = CSV.read("P2/RESULTADOS/resultados_crossval_knn.csv", DataFrame)
df_dome = CSV.read("P2/RESULTADOS/resultados_crossval_dome.csv", DataFrame)
df_rna = CSV.read("P2/RESULTADOS/resumen_resultados_crossval_rna.csv", DataFrame)  # generado por plotsRNA
df_dt = CSV.read("P2/RESULTADOS/resultados_crossval_dt.csv", DataFrame)    # generado por plotsDT
...
savefig("P2/IMÁGENES/comparativa_accuracy_modelos.png")

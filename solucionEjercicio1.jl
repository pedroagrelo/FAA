using DelimitedFiles
    ...
    if numClasses<=2
        ...
        targets = oneHot; #hcat ... construye la matriz concatena horizontalmente los vectores generados  y luego son traspuestos para quedar en vertical 
    end;
    ...
    #150 x 3 de tipo bitArray asi identifico nunha matriz de 3 columnas a cal corresponde cada clase/identificacion 
    print(targets'); #faino ben
